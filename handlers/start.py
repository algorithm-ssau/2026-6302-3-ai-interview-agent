...
*Как пользоваться:*
1️⃣ Выберите тему
2️⃣ Выберите уровень сложности: Junior / Middle / Senior
3️⃣ Выберите режим собеседования
4️⃣ Отвечайте на вопросы голосом или текстом
5️⃣ После ответа получите оценку от 0 до 10 и обратную связь
6️⃣ Используйте кнопки управления:
